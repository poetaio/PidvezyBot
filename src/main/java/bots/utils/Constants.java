...
//    String ROLE_PASSENGER = "Підвезіть";
    ...
    String CHOOSE_FROM_STATION = "З вокзалу";
    String CHOOSE_TO_STATION = "На вокзал";

    String ENTER_TO_ADDRESS = "Введіть адресу прибуття";
    String ENTER_FROM_ADDRESS = "Введіть адресу відправлення";
//    String ENTER_ADDRESS = "*введення тексту";
    String APPROVE_ADDRESS = "Підтвердити";
