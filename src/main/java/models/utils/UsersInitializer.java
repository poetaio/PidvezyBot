...
//            tripService.addAddressToTrip(tripDao.getPassenger().getChatId(), tripDao.getAddress());
//            tripService.addDetailsToTrip(tripDao.getPassenger().getChatId(), tripDao.getDetails());
